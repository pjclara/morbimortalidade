...
interface ComplicacaoItem {
    id: number;
    [key: string]: any;
}

interface Props {
    items: ComplicacaoItem[];
}
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex justify-between items-center mb-4">
                    <h1 className="text-2xl font-semibold">Complicacao</h1>
                    <Link
                        href={"/Complicacao/create"}
              ...
              <td>{i.created_at}</td>
              <td>{i.deleted_at}</td>
              <td>{i.grupo_complicacao_id}</td>
              <td>{i.id}</td>
              <td>{i.nome}</td>
              <td>{i.updated_at}</td>
                                    <td>
                                        <Link
                                            href={"/Complicacao/" + i.id + "/edit"}
