...
export default function Index({ items }: Props) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Procedimento" />

            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex justify-between items-center mb-4">
                    <h1 className="text-2xl font-semibold">Procedimento</h1>
                    <Link
                        href={"/Procedimento/create"}
              ...
              <td>{i.deleted_at}</td>
              <td>{i.descricao}</td>
              <td>{i.grupo_procedimento_id}</td>
              <td>{i.id}</td>
              <td>{i.nome}</td>
              <td>{i.updated_at}</td>
                                    <td>
                                        <Link
                                            href={"/Procedimento/" + i.id + "/edit"}
